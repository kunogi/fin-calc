...
# main story
an original formula you learn from any sources such like some stock softwares or wikipedia:
```
MA(CLOSE, 123)
```
which aims to calculate 123 days/months/minutes of the moving average of the close prices.<br/>
```
