...
export default function (arr_: iKData[], customData_: iWR['param'] = { prop: 'close', v0: 1, v1: 0 }): iWR['data'][] {
  ...
  let wr1Arr: number[] = FinUtil.arrOp(FinUtil.arrOp(FinUtil.arrOp(FinUtil.hhv(highArr, v0), closeArr, '-'), 100, '*'), FinUtil.arrOp(FinUtil.hhv(highArr, v0), FinUtil.llv(lowArr, v0), '-'), '/'),
